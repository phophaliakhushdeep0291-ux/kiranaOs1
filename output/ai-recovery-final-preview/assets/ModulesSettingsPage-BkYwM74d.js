...
import{k as i,K as t,a5 as a,cz as l,cA as r,B as d,cB as n}from"./index-1NyO63cV.js"
import{S as o}from"./switch-rbX9YkAm.js"
import{S as c}from"./SettingsShell-HQpg_NOW.js"
import{C as m,a as h,B as x,R as p}from"./ui-C9ed1kNY.js"
import{u}from"./use-settings-prefs-BG9cwniN.js"
...
import"./queries-CI1DFos2.js"
import"./query-options-DZ4mp_BJ.js"
const v=e=>["Billing","Dashboard","Cloud Backup",e("settings.hub.title")]
function y(){const{t:y}=i(),{toast:k}=t(),{patch:N}=u(),{isEnabled:w,setVisibility:B,patchVisibility:z}=a(),S=e.useMemo(()=>l.filter(e=>r(e.id)),[w]),C=e.useMemo(()=>S.filter(e=>!w(e.id)).length,[S,w])
...
for(const t of S)t.group===e&&(i[t.id]=s)
