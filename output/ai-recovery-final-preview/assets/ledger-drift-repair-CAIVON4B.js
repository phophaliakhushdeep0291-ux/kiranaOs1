import{aB as e,aM as t,N as r,T as n,J as a,P as s,M as o,Z as i,c5 as l,c6 as c,bI as u,aA as d,aZ as m,bG as g}from"./index-1NyO63cV.js"
import{resyncUdharLedgerFromServer as f}from"./cloud-hydration-CsdvLLFt.js"
import{r as h}from"./sync-reconcile-B0FuQ3dz.js"
...
return Number.isFinite(r)?r:t}function M(e){return"string"==typeof e.deleted_at||"string"==typeof e.deletedAt}function T(e,t){for(const r of t){const t=e[r]
if("string"==typeof t&&t.trim().length>0)return t.trim()
if("number"==typeof t&&Number.isFinite(t))return String(t)}return null}function B(e){return T(e,["customerId","customer_id","serverCustomerId","server_customer_id","localCustomerId","local_customer_id"])}function C(t){const r=t
...
if(s<=0)return null
const o=T(r,["payment_id","paymentId","source_id","sourceId","client_payment_id","clientPaymentId"]),i=c(t)
...
const a=T(e,["local_id","localId"]),s=T(e,["server_id","serverId"])
a&&s&&(r.has(a)&&!r.has(s)&&(r.add(s),n=!0),r.has(s)&&!r.has(a)&&(r.add(a),n=!0))}}return r}function U(e){return e?T(e,["customerMobile","customer_mobile","mobile","phone"]):null}function $(){return r("customers",[]).filter(e=>!M(e)).map(e=>{const t=n(Math.max(0,Number(e.udharAmount??e.totalUdhar??0))),r=Number(e.udharLimit??Number.POSITIVE_INFINITY)
...
async function F(){(()=>{if(E||"undefined"==typeof window)return
E=!0
...
return{id:e,name:(a=r,(a?T(a,["customerName","customer_name","name"]):null)??"Ledger customer"),mobile:U(r),type:"udhar",udharAmount:0,totalUdhar:0,createdAt:n,updatedAt:n,created_at:n,updated_at:n,sync_status:"synced",ledger_only:!0}
...
return{...e,ledgerBalance:a,rawLedgerBalance:r.balance,hasUnsyncedLedgerEntries:y(t),totalUdhar:a,udharAmount:a,ledgerMetrics:r}}).sort((e,t)=>t.ledgerBalance-e.ledgerBalance||e.name.localeCompare(t.name))}async function x(e){const[t,n]=await Promise.all([F(),a.getAll("id_mappings").catch(()=>[])]),c=t.find(t=>D(P(t),n).has(e))
if(!c)return null
...
return!!t&&u.has(t)}),_=r("bills",[]),p=o(L([..._,...m].filter(e=>!M(e)))).filter(e=>{const t=T(e,["customerId","customer_id","serverCustomerId","server_customer_id","localCustomerId","local_customer_id"])
return!!t&&u.has(t)}).sort((e,t)=>String(t.businessDate??t.business_date??t.createdAt??t.created_at??"").localeCompare(String(e.businessDate??e.business_date??e.createdAt??e.created_at??""))),y=g.filter(e=>{const t=T(e,["customerId","customer_id","serverCustomerId","server_customer_id","localCustomerId","local_customer_id"])
return!!t&&u.has(t)}),b=h.map(C).filter(e=>null!==e),I=i([...y,...b]).sort((e,t)=>String(t.paidAt??t.paid_at??t.createdAt??t.created_at??"").localeCompare(String(e.paidAt??e.paid_at??e.createdAt??e.created_at??""))),S=f.filter(e=>String(e.entity_id??"")===c.id||String(e.customerId??e.customer_id??"")===c.id).sort((e,t)=>String(t.createdAt??t.created_at??"").localeCompare(String(e.createdAt??e.created_at??"")))
...
W=Date.now()
try{return await f(),await h().catch(()=>{}),!0}catch{return W=0,!1}}export{Y as a,z as b,V as c,q as d,$ as e,O as f,N as g,F as h,x as l,A as p,w as r,I as t}
