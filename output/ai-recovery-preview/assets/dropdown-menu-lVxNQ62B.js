...
import{c4 as r,bp as o,bs as t,bk as a,bt as s,bu as d,bv as i,bb as c,be as u,br as l,c3 as p,bw as f,c9 as m,bz as h,bx as v,bA as w,bB as g,bC as x,by as y,bD as b,ca as _,bo as M,bq as j,l as D}from"./index-DhCGH5L2.js"
import{u as R}from"./index-CxWW_46C.js"
import{c as C,I as N,R as k}from"./index-BlqwGr5S.js"
import{u as P,aZ as O,bi as I}from"./vendor-ui-CIi-vqR6.js"
var E=["Enter"," "],T=["ArrowUp","PageDown","End"],S=["ArrowDown","PageUp","Home",...T],F={ltr:[...E,"ArrowRight"],rtl:[...E,"ArrowLeft"]},L={ltr:["ArrowLeft"],rtl:["ArrowRight"]},K="Menu",[A,G,z]=p(K),[V,U]=a(K,[z,s,C]),B=s(),X=C(),[Y,Z]=V(K),[q,H]=V(K),W=t=>{const{__scopeMenu:a,open:s=!1,children:d,dir:i,onOpenChange:c,modal:u=!0}=t,l=B(a),[p,f]=e.useState(null),m=e.useRef(!1),h=r(c),v=R(i)
...
return document.addEventListener("keydown",e,{capture:!0}),()=>{document.removeEventListener("keydown",e,{capture:!0}),document.removeEventListener("pointerdown",n,{capture:!0}),document.removeEventListener("pointermove",n,{capture:!0})}},[]),n.jsx(o,{...l,children:n.jsx(Y,{scope:a,open:s,onOpenChange:h,content:p,onContentChange:f,children:n.jsx(q,{scope:a,onClose:e.useCallback(()=>h(!1),[h]),isUsingKeyboardRef:m,dir:v,modal:u,children:d})})})}
W.displayName=K
var J=e.forwardRef((e,r)=>{const{__scopeMenu:o,...a}=e,s=B(o)
return n.jsx(t,{...s,...a,ref:r})})
J.displayName="MenuAnchor"
var Q="MenuPortal",[$,ee]=V(Q,{forceMount:void 0}),ne=e=>{const{__scopeMenu:r,forceMount:o,children:t,container:a}=e,s=Z(Q,r)
return n.jsx($,{scope:r,forceMount:o,children:n.jsx(d,{present:o||s.open,children:n.jsx(i,{asChild:!0,container:a,children:t})})})}
ne.displayName=Q
var re="MenuContent",[oe,te]=V(re),ae=e.forwardRef((e,r)=>{const o=ee(re,e.__scopeMenu),{forceMount:t=o.forceMount,...a}=e,s=Z(re,e.__scopeMenu),i=H(re,e.__scopeMenu)
return n.jsx(A.Provider,{scope:e.__scopeMenu,children:n.jsx(d,{present:t||s.open,children:n.jsx(A.Slot,{scope:e.__scopeMenu,children:i.modal?n.jsx(se,{...a,ref:r}):n.jsx(de,{...a,ref:r})})})})}),se=e.forwardRef((r,o)=>{const t=Z(re,r.__scopeMenu),a=e.useRef(null),s=c(o,a)
return e.useEffect(()=>{const e=a.current
if(e)return f(e)},[]),n.jsx(ce,{...r,ref:s,trapFocus:t.open,disableOutsidePointerEvents:t.open,disableOutsideScroll:!0,onFocusOutside:u(r.onFocusOutside,e=>e.preventDefault(),{checkForDefaultPrevented:!1}),onDismiss:()=>t.onOpenChange(!1)})}),de=e.forwardRef((e,r)=>{const o=Z(re,e.__scopeMenu)
return n.jsx(ce,{...e,ref:r,trapFocus:!1,disableOutsidePointerEvents:!1,disableOutsideScroll:!1,onDismiss:()=>o.onOpenChange(!1)})}),ie=y("MenuContent.ScrollLock"),ce=e.forwardRef((r,o)=>{const{__scopeMenu:t,loop:a=!1,trapFocus:s,onOpenAutoFocus:d,onCloseAutoFocus:i,disableOutsidePointerEvents:l,onEntryFocus:p,onEscapeKeyDown:f,onPointerDownOutside:m,onFocusOutside:y,onInteractOutside:b,onDismiss:_,disableOutsideScroll:M,...j}=r,D=Z(re,t),R=H(re,t),C=B(t),N=X(t),P=G(t),[O,I]=e.useState(null),E=e.useRef(null),F=c(o,E,D.onContentChange),L=e.useRef(0),K=e.useRef(""),A=e.useRef(0),z=e.useRef(null),V=e.useRef("right"),U=e.useRef(0),Y=M?v:e.Fragment,q=M?{as:ie,allowPinchZoom:!0}:void 0
e.useEffect(()=>()=>window.clearTimeout(L.current),[]),h()
const W=e.useCallback(e=>V.current===z.current?.side&&((e,n)=>!!n&&((e,n)=>{const{x:r,y:o}=e
let t=!1
...
var pe="MenuItem",fe="menu.itemSelect",me=e.forwardRef((r,o)=>{const{disabled:t=!1,onSelect:a,...s}=r,d=e.useRef(null),i=H(pe,r.__scopeMenu),l=te(pe,r.__scopeMenu),p=c(o,d),f=e.useRef(!1)
...
var[ke,Pe]=V("MenuSub"),Oe="MenuSubTrigger",Ie=e.forwardRef((r,o)=>{const t=Z(Oe,r.__scopeMenu),a=H(Oe,r.__scopeMenu),s=Pe(Oe,r.__scopeMenu),d=te(Oe,r.__scopeMenu),i=e.useRef(null),{pointerGraceTimerRef:c,onPointerGraceIntentChange:l}=d,p={__scopeMenu:r.__scopeMenu},f=e.useCallback(()=>{i.current&&window.clearTimeout(i.current),i.current=null},[])
return e.useEffect(()=>f,[f]),e.useEffect(()=>{const e=c.current
return()=>{window.clearTimeout(e),l(null)}},[c,l]),n.jsx(J,{asChild:!0,...p,children:n.jsx(he,{id:s.triggerId,"aria-haspopup":"menu","aria-expanded":t.open,"aria-controls":t.open?s.contentId:void 0,"data-state":Se(t.open),...r,ref:_(o,s.onTriggerChange),onClick:e=>{r.onClick?.(e),r.disabled||e.defaultPrevented||(e.currentTarget.focus(),t.open||t.onOpenChange(!0))},onPointerMove:u(r.onPointerMove,Ke(e=>{d.onItemEnter(e),e.defaultPrevented||r.disabled||t.open||i.current||(d.onPointerGraceIntentChange(null),i.current=window.setTimeout(()=>{t.onOpenChange(!0),f()},100))})),onPointerLeave:u(r.onPointerLeave,Ke(e=>{f()
...
Ie.displayName=Oe
var Ee="MenuSubContent",Te=e.forwardRef((r,o)=>{const t=ee(re,r.__scopeMenu),{forceMount:a=t.forceMount,align:s="start",...i}=r,l=Z(re,r.__scopeMenu),p=H(re,r.__scopeMenu),f=Pe(Ee,r.__scopeMenu),m=e.useRef(null),h=c(o,m)
...
var Ae=W,Ge=J,ze=ne,Ve=ae,Ue=ue,Be=le,Xe=me,Ye=ve,Ze=ye,qe=_e,He=Re,We=Ce,Je=Ne,Qe=Ie,$e=Te,en="DropdownMenu",[nn]=a(en,[U]),rn=U(),[on,tn]=nn(en),an=r=>{const{__scopeDropdownMenu:o,children:t,dir:a,open:s,defaultOpen:d,onOpenChange:i,modal:c=!0}=r,u=rn(o),l=e.useRef(null),[p,f]=M({prop:s,defaultProp:d??!1,onChange:i,caller:en})
...
return n.jsx(Je,{...a,...t,ref:r})}).displayName="DropdownMenuArrow"
...
return n.jsx($e,{...a,...t,ref:r,style:{...e.style,"--radix-dropdown-menu-content-transform-origin":"var(--radix-popper-transform-origin)","--radix-dropdown-menu-content-available-width":"var(--radix-popper-available-width)","--radix-dropdown-menu-content-available-height":"var(--radix-popper-available-height)","--radix-dropdown-menu-trigger-width":"var(--radix-popper-anchor-width)","--radix-dropdown-menu-trigger-height":"var(--radix-popper-anchor-height)"}})})
