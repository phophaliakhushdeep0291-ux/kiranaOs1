import{f as e,L as t,m as r,i as a,a as n,A as i,b as o,c as s,d as l,e as c,h as p,g as u,u as y,j as h,G as m,k as d,l as f,D as v,n as b,o as A}from"./generateCategoricalChart-CkWIg6_1.js"
import{f as x,a as g}from"./vendor-data-BaHBZjtO.js"
import{bE as O}from"./index-DnTeTJJW.js"
import{X as P,Y as j}from"./YAxis-Ramzzv12.js"
var E,w=["layout","type","stroke","connectNulls","isRange","ref"],k=["key"]
...
var A=this.state.isAnimationFinished,g=1===o.length,P=O("recharts-area",l),j=h&&h.allowDataOverflow,E=m&&m.allowDataOverflow,w=j||E,k=s(b)?this.id:b,S=null!==(r=e(i,!1))&&void 0!==r?r:{r:3,strokeWidth:2},D=S.r,M=void 0===D?3:D,L=S.strokeWidth,N=void 0===L?2:L,C=(p(i)?i:{}).clipDot,B=void 0===C||C,I=2*M+N
return x.createElement(t,{className:P},j||E?x.createElement("defs",null,x.createElement("clipPath",{id:"clipPath-".concat(k)},x.createElement("rect",{x:j?y:y-d/2,y:E?c:c-f/2,width:j?d:2*d,height:E?f:2*f})),!B&&x.createElement("clipPath",{id:"clipPath-dots-".concat(k)},x.createElement("rect",{x:y-I/2,y:c-I/2,width:d+I,height:f+I}))):null,g?null:this.renderArea(w,k),(i||g)&&this.renderDots(w,B,k),(!v||A)&&u.renderCallByParent(this.props,o))}}])&&C(d.prototype,f),v&&C(d,v),Object.defineProperty(d,"prototype",{writable:!1}),d
var d,f,v}()
E=z,T(z,"displayName","Area"),T(z,"defaultProps",{stroke:"#3182bd",fill:"#3182bd",fillOpacity:.6,xAxisId:0,yAxisId:0,legendType:"line",connectNulls:!1,points:[],dot:!1,activeDot:!0,hide:!1,isAnimationActive:!m.isSsr,animationBegin:0,animationDuration:1500,animationEasing:"ease"}),T(z,"getBaseValue",(e,t,r,n)=>{var i=e.layout,o=e.baseValue,s=t.props.baseValue,l=null!=s?s:o
