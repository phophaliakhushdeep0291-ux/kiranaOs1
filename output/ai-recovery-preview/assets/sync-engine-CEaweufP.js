const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/cloud-hydration-7ZLaFtau.js","assets/index-DhCGH5L2.js","assets/vendor-data-BaHBZjtO.js","assets/vendor-react-CdF70ZyV.js","assets/vendor-ui-CIi-vqR6.js","assets/vendor-validation-C84QDzN5.js","assets/index-BEjh-wr3.css","assets/sync-reconcile-btNMUEr7.js","assets/sync-types-B187FdZc.js"])))=>i.map(i=>d[i]);
import{dz as e,dq as t,aO as n,dA as a,dB as s,dC as r,ar as i,a_ as o,J as c,b2 as l,ds as d,bL as u,dD as _,dE as p,p as f,ce as y,aJ as w,A as h,dx as v,t as g}from"./index-DhCGH5L2.js"
import{w as m,u as S,x as b,q as C}from"./sync-reconcile-btNMUEr7.js"
import{c as E,d as O,p as A,b as k}from"./sync-push-BfdTogiR.js"
import{d as D,e as F,r as L}from"./sync-status-repair-CP18WTtH.js"
import{e as N,t as I}from"./sync-types-B187FdZc.js"
import"./vendor-data-BaHBZjtO.js"
import{p as x,a as R}from"./api-B2_aluva.js"
...
return{...await e()}},async PULL_FROM_CLOUD(){const{hydrateFromBackendSnapshot:e}=await n(async()=>{const{hydrateFromBackendSnapshot:e}=await import("./cloud-hydration-7ZLaFtau.js")
...
const n=e
for(const a of t)if("string"==typeof n[a]&&n[a])return n[a]}const q=new Map
function Y(e={}){const t=i(),n=`${t.tenant_id}:${t.store_id}`,a=q.get(n)
...
return q.set(n,u),r.then(()=>{u.inFlight=!1},()=>{u.inFlight=!1}),r}async function B(e){return{pushed:0,pulled:0,conflicts:0,failed:0,pending:(await L()).totalBlocking,skipped:0,cursor:e}}let J=null,V=null
...
if("applied"===n.status?e+=1:t+=1,a.reloadsApp||await R(a.id,{status:n.status,result:n.result,error:n.error}).catch(()=>null),a.reloadsApp)break}}catch{return{ran:e,failed:t}}return{ran:e,failed:t}})()}finally{T=!1}})(),["owner","admin"].includes(String(y().user?.role??""))&&Y().catch(()=>{})
const n=await(async()=>(await v()).cloudSyncAllowed)()
let a,s=null
...
await D({recoverAbandonedSyncing:e}).catch(()=>0),await F().catch(()=>0)
const r=Date.now()
let i,o,l
try{i=await O(),o=await A()}catch(d){throw G(h.SYNC_FAILED,Date.now()-r,{reason:d instanceof w?d.data?.code??String(d.status):"unknown"}),d}await D().catch(()=>0)
try{l=await L()}catch(d){throw G(h.SYNC_FAILED,Date.now()-r,{reason:"local_queue_unavailable"}),d}return(i.pushed+o.pulled+i.failed+i.conflicts+o.conflicts>0||o.failed)&&G(i.failed>0||o.failed?h.SYNC_FAILED:h.SYNC_COMPLETED,Date.now()-r,{pushed:i.pushed,pulled:o.pulled,failed:i.failed,conflicts:i.conflicts+o.conflicts,...o.failed?{pullFailed:!0,reason:o.failureReason??"unknown"}:{}}),{pushed:i.pushed,pulled:o.pulled,conflicts:i.conflicts+o.conflicts,failed:i.failed,pending:l.totalBlocking,skipped:i.skipped,cursor:o.cursor,pullFailed:o.failed,pullFailureReason:o.failureReason}}function G(e,t,n){g(e,n,{durationMs:t,module:"sync"})}async function H(e,t=[]){await l.open()
