import{ak as e,aV as t,ar as n,aN as r,b2 as i,bL as a,J as o,a_ as s,T as l,bN as c,bO as d,bP as u,bQ as _,bR as p,X as y,M as m,Z as f,P as g,U as h}from"./index-DnTeTJJW.js"
...
return Object.keys(t).length>0?JSON.stringify(t):void 0}function O(t){return e("/sync/push",{method:"POST",body:JSON.stringify(t)})}function k(n){const r="string"==typeof n||"number"==typeof n||null==n?{cursor:n??null}:n
...
return"ownerpinprovided"!==t&&F.test(t)}function q(e){if(Array.isArray(e))return e.map(e=>q(e))
if("object"!=typeof e||null===e)return e
const t={}
for(const[n,r]of Object.entries(e))D(n)||(t[n]=q(r))
return t}function J(e){const t=q(e)
...
return((e,t,n)=>{const r=Y(e,["creditAmount","credit_amount","dueAmount","due_amount"],ee(e.payments,!0))
if(r<=0)return n
const i=Y(e,["paidAmount","paid_amount","buyerPaidAmount","buyer_paid_amount"],ee(e.payments,!1)),a=Y(n,["grandTotal","grand_total","totalAmount","total_amount","netAmount","net_amount","actualAmount","actual_amount"],i+r),o=Y(t,["creditAmount","credit_amount","dueAmount","due_amount"],ee(t.payments,!0)),s=Y(t,["paidAmount","paid_amount","buyerPaidAmount","buyer_paid_amount"],ee(t.payments,!1)),l=Array.isArray(t.payments)&&t.payments.some(e=>b(e)&&"credit"===String(e.mode??"").toLowerCase())
...
if(!u&&!_&&!o)return void(t&&t!==n&&await X(t,n))
...
t&&t!==n&&await X(t,n)}async function ie(e,t,n){const r=I(e.operation_type,e.entity_type),o=v(r)
...
if(!l)return"ignored"
const y=await Ie(l),m=w(s,["local_id","localId","localBillId","local_bill_id","clientBillId","client_bill_id","localProductId","local_product_id","clientProductId","client_product_id"])??y,f="payments"===o?await c(s):void 0,g="customer_ledger"===o?await(async(e,t)=>{const n=Se(e),r=Oe(e),o="bill"===n||"debit"===n||"BILL"===String(e.type??"").toUpperCase()
if(!r&&!o)return
...
const n=Se(e),i="bill"===n||"debit"===n||"BILL"===String(e.type??"").toUpperCase(),a=Oe(e)
if(o&&!i)return!1
if(r&&!a)return!1
...
await e.bulkDelete([...new Set(t)])}return"merged"}const S="bills"!==o||null==A||d(A)||!d(s)||!u(A,s)&&(_(A)&&_(s)||!p(A,s))?void 0:A,P=w(f??g??S??{},["id","local_id","localId"]),O=b??P,k=null!=A&&N.has(String(A.sync_status??"synced"))&&!w(A,["server_id","serverId"])&&Boolean(b)&&w(A,["id","local_id","localId"])===b
if("purchase_bills"===o){const e={...s,id:l,server_id:l,local_id:b??m},n=await ge().catch(()=>({keys:new Set}))
if(A&&_e(A)||fe(e,n))return await H(I("",t),O??b,l),"ignored"}if(A&&!f&&!g&&!S&&!k&&N.has(String(A.sync_status??"synced"))){await $({entityType:I("",t),entityId:w(A,["id"])??l,sourceId:w(e,["change_id"])??String(e.server_version??e.version??Date.now()),localSnapshot:A,serverSnapshot:s,errorMessage:"Server changed an entity that has unsynced local changes"})
const n=i.table(o)
return await n.put({...A,sync_status:"conflict"}),"conflict"}return await H(I("",t),O,l),await re(t,O??l,l,s),"merged"}function Be(e){return new Set([e.id,e.local_id,e.localId,e.server_id,e.serverId].filter(e=>"string"==typeof e&&e.length>0))}function Me(e){const t=e.customerId??e.customer_id
