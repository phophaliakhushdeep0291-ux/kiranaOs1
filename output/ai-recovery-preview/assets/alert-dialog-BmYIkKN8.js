...
import{b8 as s,b9 as t,ba as o,bb as r,bc as l,bd as i,be as n,bf as d,bg as c,bh as f,bi as m,bj as p,bk as u,bl as g,l as x,bm as N}from"./index-DnTeTJJW.js"
...
F.displayName=z
var $="AlertDialogDescription",k=a.forwardRef((a,s)=>{const{__scopeAlertDialog:t,...o}=a,r=j(t)
return e.jsx(c,{...r,...o,ref:s})})
k.displayName=$
var C=a.forwardRef((a,s)=>{const{__scopeAlertDialog:t,...o}=a,r=j(t)
return e.jsx(f,{...r,...o,ref:s})})
C.displayName="AlertDialogAction"
var I="AlertDialogCancel",E=a.forwardRef((a,s)=>{const{__scopeAlertDialog:t,...o}=a,{cancelRef:l}=R(I,t),i=j(t),n=r(s,l)
...
return a.useEffect(()=>{document.getElementById(e.current?.getAttribute("aria-describedby"))},[s,e]),null},S=D,T=O,q=C,B=E,H=F,Y=k
