...
import{bo as r,bp as t,bq as n,bb as a,br as s,be as i,bs as d,bt as p,bu as c,bv as u,bk as l,bw as f,bx as v,by as h,bz as g,bA as m,bB as b,bC as x,bD as P,l as C}from"./index-C-jOBSyf.js"
...
var F="PopoverTrigger",D=e.forwardRef((e,r)=>{const{__scopePopover:t,...n}=e,p=_(F,t),c=j(t),u=a(r,p.triggerRef),l=o.jsx(s.button,{type:"button","aria-haspopup":"dialog","aria-expanded":p.open,"aria-controls":p.open?p.contentId:void 0,"data-state":U(p.open),...n,ref:u,onClick:i(e.onClick,p.onOpenToggle)})
...
return g(),o.jsx(m,{asChild:!0,loop:!0,trapped:n,onMountAutoFocus:a,onUnmountAutoFocus:s,children:o.jsx(b,{asChild:!0,disableOutsidePointerEvents:i,onInteractOutside:u,onEscapeKeyDown:d,onPointerDownOutside:p,onFocusOutside:c,onDismiss:()=>f.onOpenChange(!1),children:o.jsx(x,{"data-state":U(f.open),role:"dialog",id:f.contentId,...v,...l,ref:r,style:{...l.style,"--radix-popover-content-transform-origin":"var(--radix-popper-transform-origin)","--radix-popover-content-available-width":"var(--radix-popper-available-width)","--radix-popover-content-available-height":"var(--radix-popper-available-height)","--radix-popover-trigger-width":"var(--radix-popper-anchor-width)","--radix-popover-trigger-height":"var(--radix-popper-anchor-height)"}})})})}),B="PopoverClose"
function U(e){return e?"open":"closed"}e.forwardRef((e,r)=>{const{__scopePopover:t,...n}=e,a=_(B,t)
return o.jsx(s.button,{type:"button",...n,ref:r,onClick:i(e.onClick,()=>a.onOpenChange(!1))})}).displayName=B,e.forwardRef((e,r)=>{const{__scopePopover:t,...n}=e,a=j(t)
return o.jsx(P,{...a,...n,ref:r})}).displayName="PopoverArrow"
var Z=I,G=z
const H=y,J=D,L=e.forwardRef(({className:e,align:r="center",sideOffset:t=4,...n},a)=>o.jsx(Z,{children:o.jsx(G,{ref:a,align:r,sideOffset:t,className:C("z-50 w-72 rounded-md border bg-popover p-4 text-popover-foreground shadow-md outline-none data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 origin-[var(--radix-popover-content-transform-origin)]",e),...n})}))
