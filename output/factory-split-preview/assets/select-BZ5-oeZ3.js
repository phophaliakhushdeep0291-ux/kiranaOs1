...
import{b7 as n,bY as o,bn as r,bk as a,bm as l,bl as s,bZ as i,bo as c,ba as d,br as u,bq as p,b_ as f,bp as m,b$ as h,c0 as v,bg as x,bs as g,bv as w,bt as y,bw as b,bx as S,bu as C,by as j,bz as N,l as _}from"./index-CYG8yywH.js"
...
var Q="SelectPortal",[J,ee]=V(Q,{forceMount:void 0}),te=t=>{const{__scopeSelect:n,forceMount:o,...r}=t
return e.jsx(J,{scope:t.__scopeSelect,forceMount:o,children:e.jsx(u,{asChild:!0,...r})})}
te.displayName=Q
...
o&&setTimeout(()=>o.ref.current.focus())}),X=t.useCallback((e,t,n)=>{const o=!F.current&&!n;(void 0!==R.value&&R.value===t||o)&&(M(e),o&&(F.current=!0))},[R.value]),$=t.useCallback(()=>P?.focus(),[P]),G=t.useCallback((e,t,n)=>{const o=!F.current&&!n;(void 0!==R.value&&R.value===t||o)&&L(e)},[R.value]),Q="popper"===l?ue:de,J=Q===ue?{side:u,sideOffset:p,align:f,alignOffset:m,arrowPadding:h,collisionBoundary:v,collisionPadding:x,sticky:C,hideWhenDetached:j,avoidCollisions:N}:{}
return e.jsx(le,{scope:a,content:P,viewport:T,onViewportChange:k,itemRefCallback:X,selectedItem:E,onItemLeave:$,itemTextRefCallback:G,focusSelectedItem:z,selectedItemText:O,position:l,isPositioned:V,searchRef:Y,children:e.jsx(y,{as:ie,allowPinchZoom:!0,children:e.jsx(b,{asChild:!0,trapped:R.open,onMountAutoFocus:e=>{e.preventDefault()},onUnmountAutoFocus:d(s,e=>{R.trigger?.focus({preventScroll:!0}),e.preventDefault()}),children:e.jsx(S,{asChild:!0,disableOutsidePointerEvents:!0,onEscapeKeyDown:i,onPointerDownOutside:c,onFocusOutside:e=>e.preventDefault(),onDismiss:()=>R.onOpenChange(!1),children:e.jsx(Q,{role:"listbox",id:R.contentId,"data-state":R.open?"open":"closed",dir:R.dir,onContextMenu:e=>e.preventDefault(),..._,...J,onPlaced:()=>B(!0),ref:D,style:{display:"flex",flexDirection:"column",outline:"none",..._.style},onKeyDown:d(_.onKeyDown,e=>{const t=e.ctrlKey||e.altKey||e.metaKey
