const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CYG8yywH.js","assets/vendor-data-BaHBZjtO.js","assets/vendor-react-CdF70ZyV.js","assets/vendor-ui-CIi-vqR6.js","assets/vendor-validation-C84QDzN5.js","assets/index-B-026ryc.css"])))=>i.map(i=>d[i]);
import{aO as t}from"./index-CYG8yywH.js"
...
if(n)try{const{offlineDB:e}=await t(async()=>{const{offlineDB:t}=await import("./index-CYG8yywH.js").then(t=>t.ek)
