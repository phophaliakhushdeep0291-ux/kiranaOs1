...
import{c0 as r,bl as o,bo as t,bg as a,bp as s,bq as d,br as i,b7 as c,ba as u,bn as l,b$ as p,bs as f,c5 as m,bv as h,bt as v,bw as w,bx as g,by as x,bu as y,bz as b,c6 as _,bk as M,bm as j,l as D}from"./index-DbQMpL2c.js"
import{u as R}from"./index-CxWW_46C.js"
import{c as C,I as N,R as k}from"./index-DjQ2Vtyg.js"
...
var J="MenuPortal",[Q,ee]=V(J,{forceMount:void 0}),ne=e=>{const{__scopeMenu:r,forceMount:o,children:t,container:a}=e,s=Z(J,r)
...
var Ae=W,Ge=$,ze=ne,Ve=ae,Ue=ue,Be=le,Xe=me,Ye=ve,Ze=ye,qe=_e,He=Re,We=Ce,$e=Ne,Je=Ie,Qe=Te,en="DropdownMenu",[nn]=a(en,[U]),rn=U(),[on,tn]=nn(en),an=r=>{const{__scopeDropdownMenu:o,children:t,dir:a,open:s,defaultOpen:d,onOpenChange:i,modal:c=!0}=r,u=rn(o),l=e.useRef(null),[p,f]=M({prop:s,defaultProp:d??!1,onChange:i,caller:en})
