...
import{k as i,K as t,a5 as a,cu as l,cv as r,B as d,cw as n}from"./index-DbQMpL2c.js"
import{S as o}from"./switch-C5VNVCik.js"
import{S as c}from"./SettingsShell-BDkDNdGF.js"
import{C as m,a as h,B as x,R as p}from"./ui-jkfgl_d5.js"
import{u}from"./use-settings-prefs-CKRZRQuB.js"
...
for(const t of z)t.group===e&&(i[t.id]=s)
N({moduleVisibility:S(i)})})(e,!t),children:t?"Hide all":"Show all"})}),s.jsx("div",{className:"px-5 pb-4",children:i.map((e,t)=>s.jsx(p,{label:e.label,desc:e.description,last:t===i.length-1,pill:s.jsx(o,{checked:w(e.id),onCheckedChange:s=>((e,s)=>{N({moduleVisibility:S({[e]:s})})})(e.id,s)})},e.id))})]},e)})]})}export{y as default}
