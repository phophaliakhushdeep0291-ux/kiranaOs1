import{aB as e,aM as t,N as r,T as n,J as a,P as s,M as o,Z as i,c1 as l,c2 as c,bE as u,aA as d,aZ as m,bC as g}from"./index-DbQMpL2c.js"
import{resyncUdharLedgerFromServer as f}from"./cloud-hydration-c9ELc8tY.js"
import{r as h}from"./sync-reconcile-MR5x3Lmq.js"
...
if("number"==typeof t&&Number.isFinite(t))return String(t)}return null}function T(e){return C(e,["customerId","customer_id","serverCustomerId","server_customer_id","localCustomerId","local_customer_id"])}function B(t){const r=t
...
return{id:o??`ledger-payment:${t.id}`,customer_id:T(t),amount:s,mode:a,note:"string"==typeof t.note?t.note:null,paid_at:i,created_at:i,reversed_at:t.reversed_at??null,ledger_entry_id:t.id,sync_status:t.sync_status??"synced",derived_from_ledger:!0}}function L(e){const t=new Map
...
if(!c)return null
const u=D(P(c),n),[d,m,g,f]=await Promise.all([a.getAll("customer_ledger").catch(()=>[]),a.getAll("bills").catch(()=>[]),a.getAll("payments").catch(()=>[]),a.getAll("local_audit_logs").catch(()=>[])]),h=s(d).filter(e=>{const t=T(e)
