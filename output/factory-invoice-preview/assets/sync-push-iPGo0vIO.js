import{Y as e,b2 as t,J as n,aN as i,ar as r,a_ as a,b3 as s}from"./index-DbQMpL2c.js"
import{s as o,m as c,r as l,a as d,b as u,c as y,l as p,d as _,e as f,p as v,f as m,g,h}from"./sync-reconcile-MR5x3Lmq.js"
import{n as w,s as I,D as b,S as E,i as S,a as k,b as M,r as A,e as C,c as N,d as L,t as x}from"./sync-types-B187FdZc.js"
import{s as B,i as T,b as D}from"./sync-status-repair-CiPZ0ujK.js"
...
return q(e)?e?.cursor??null:null}async function V(e){void 0!==e&&""!==e&&(await t.open(),await t.sync_cursor.put(K(b,"global",e)))}async function z(e){void 0!==e&&""!==e&&(await t.open(),await t.sync_cursor.put(K(E,"server_sequence",e)))}async function Z(e){if(!e||"object"!=typeof e)return
await t.open()
const n=[]
for(const t of G){const i=e[t]
void 0!==i&&""!==i&&n.push(K(J(t),t,i))}n.length>0&&await t.sync_cursor.bulkPut(n)}function $(e){const t=S(e.sync)?e.sync:null,n=t&&S(t.entityCursors)?t.entityCursors:null
