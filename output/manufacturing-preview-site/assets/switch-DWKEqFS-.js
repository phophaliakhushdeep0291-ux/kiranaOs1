...
return r.jsx(t.button,{type:"button",role:"switch","aria-checked":l,"aria-required":u,"data-state":x(l),"data-disabled":c?"":void 0,disabled:c,value:i,...s,ref:w,onClick:n(a,e=>{p(e=>!e),g&&k&&(m.current=e.isPropagationStopped(),m.current||e.stopPropagation())})})})
m.displayName=h
...
return r.jsx(t.span,{"data-state":x(s.checked),"data-disabled":s.disabled?"":void 0,...n,ref:a})})
w.displayName=g
var v="SwitchBubbleInput",C=e.forwardRef(({__scopeSwitch:a,...n},d)=>{const{control:i,hasConsumerStoppedPropagationRef:l,checked:u,defaultChecked:f,required:p,disabled:h,name:m,value:k,form:g,bubbleInput:w,setBubbleInput:C}=b(v,a),_=o(d,C),x=c(u),S=s(i)
...
if(x!==u&&t){const r=new Event("click",{bubbles:a})
t.call(e,u),e.dispatchEvent(r)}},[w,x,u,l])
const y=e.useRef(u)
return r.jsx(t.input,{type:"checkbox","aria-hidden":!0,defaultChecked:f??y.current,required:p,disabled:h,name:m,value:k,form:g,...n,tabIndex:-1,ref:_,style:{...n.style,...S,position:"absolute",pointerEvents:"none",opacity:0,margin:0,transform:"translateX(-100%)"}})})
function _(e){return"function"==typeof e}function x(e){return e?"checked":"unchecked"}C.displayName=v
