...
- 2026-08-08: MQA-BILL-01 restaurant add-on checkout and final bill detail passed live 390x844 QA. The cashier selected Large at ₹590 and `Smoked mozzarella` at +₹85; review, Grand Total, cash collection, synced history and final detail all showed exactly ₹675. The add-on dialog exposes a labeled description and 44px option controls. Live QA caught an internally scrolling phone table that document-level overflow alone missed, so bill detail now uses a full-width premium item card while retaining the desktop table. Final geometry is document 390/390 and card 346/346, with Large, the add-on group/name/price, Qty, Rate and Total visible without horizontal scrolling. Automated bill-option/receipt/mobile-layout tests and the 3/3 backend database integration cover the snapshot plus exact ingredient consumption. The other three target viewports remain open for this restaurant transaction and MQA-BILL-01 is not yet fully closed.
