...
- 2026-08-10: MQA-BILL-01/MQA-SYNC-01 now include the 390x844 backend-unavailable Udhar variant. A walk-in was rejected, the named customer saved a local ₹675/₹0-paid bill, retry reconciled `PENDING-B87FA9` to `KOS-2026-000003`, and a repeated force sync left exactly one server bill, one ₹675 ledger debit, zero payment rows and ₹675 customer outstanding. The synced detail retains Large and the ₹85 add-on, measures 390/390 with zero sub-44px controls, and is retained under `docs/evidence/mobile-udhar/`. Sync Status also recovered visibly from one failed item to 0 pending/failed/conflicts; its audit found and fixed a separate 36px diagnostics refresh action, whose post-fix live recapture remains open. Full airplane-mode and the other three Udhar viewport captures remain open.
