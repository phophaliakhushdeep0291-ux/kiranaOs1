...
export const INNOVATION_FEATURES: InnovationFeature[] = [
  {
    ...
    planNote: "Pro feature architecture. Not fully active until voice parser backend is added.",
    entryHref: "/billing",
    ...
    currentFrontend: ["Billing has aliases, Hindi/English search, custom items, udhar and split payment support.", "Voice entry UI placeholder can route parsed drafts into the existing local-first bill draft."],
    backendRequirements: ["Speech-to-text tuned for Hindi/Hinglish kirana terms.", "Intent parser for customer, item, unit, rate, quantity and udhar amount.", "Confidence scoring and confirmation payload before bill creation."],
