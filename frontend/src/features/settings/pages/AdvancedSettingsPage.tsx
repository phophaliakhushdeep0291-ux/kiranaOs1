...
export default function AdvancedSettingsPage() {
  ...
  function copyDiagnostics() {
    const diag = { app: "Artha 2.1.3", online: navigator.onLine, language, accent, prefs: { advanced: adv }, ua: navigator.userAgent, at: new Date().toISOString() };
        ...
        <Card>
          ...
          <div className="grid grid-cols-1 gap-y-3 px-5 pb-5 sm:grid-cols-2">
            ...
            <div className="mt-1 grid gap-2 sm:col-span-2 sm:grid-cols-2">
              ...
              <Button variant="outline" className="h-9 flex-1 gap-1.5 rounded-[9px] text-[12px] font-bold" onClick={() => mailSupport("Artha diagnostics", JSON.stringify({ online: navigator.onLine, language, accent, at: new Date().toISOString() }, null, 2))}>Send to support</Button>
            </div>
          </div>
        </Card>
