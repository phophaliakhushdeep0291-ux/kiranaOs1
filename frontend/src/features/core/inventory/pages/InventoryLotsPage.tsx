...
export default function InventoryLotsPage() {
  ...
  return <PageShell>
    <div className="mb-4"><h1 className="font-display text-2xl font-black text-[var(--brand-ink)]">Batch & expiry control</h1><p className="mt-1 text-sm text-[#64748b]">FEFO stock, expiry risk, quarantine, and recall control for every branch.</p></div>
