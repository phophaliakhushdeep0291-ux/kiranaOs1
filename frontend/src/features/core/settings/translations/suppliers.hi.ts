...
export const suppliersHi: Record<keyof typeof suppliersEn, string> = {
  ...
  "suppliers.row.statement": "{name} का खाता खोलें",

  "suppliers.statement.title": "{name} का बकाया खाता",
  "suppliers.statement.loading": "सप्लायर खाता लोड हो रहा है",
  "suppliers.statement.unavailable": "खाता अभी उपलब्ध नहीं है",
  "suppliers.statement.onlineRequired": "सत्यापित खाता देखने के लिए सर्वर कनेक्शन चाहिए। आपकी लोकल खरीद नहीं हटेगी; दोबारा ऑनलाइन होकर कोशिश करें।",
  "suppliers.statement.retry": "फिर कोशिश करें",
  "suppliers.statement.balanced": "लेजर और खरीद का बकाया मेल खाता है",
  "suppliers.statement.attention": "खाते का मिलान जरूरी है",
  "suppliers.statement.coverage": "{linked} जुड़ी खरीद · एक जैसे नाम वाली {unlinked} खरीद अभी नहीं जुड़ी",
  "suppliers.statement.repair": "पुराना जुड़ा हिसाब ठीक करें",
  "suppliers.statement.repaired": "{count} पुरानी खरीद ठीक हुई",
  "suppliers.statement.noRepairNeeded": "कोई जुड़ा पुराना हिसाब ठीक नहीं करना था",
  "suppliers.statement.repairMore": "{count} खरीद ठीक हुईं। बचा पुराना हिसाब पूरा करने के लिए सुधार फिर चलाएँ।",
  "suppliers.statement.from": "इस तारीख से",
  "suppliers.statement.to": "इस तारीख तक",
  "suppliers.statement.currentDue": "लेजर बकाया",
  "suppliers.statement.purchaseDue": "खरीद बकाया",
  "suppliers.statement.opening": "शुरुआती बकाया",
  "suppliers.statement.difference": "फर्क",
  "suppliers.statement.date": "तारीख",
  "suppliers.statement.reference": "रेफरेंस",
  "suppliers.statement.purchase": "खरीद",
  "suppliers.statement.paid": "भुगतान / क्रेडिट",
  "suppliers.statement.change": "बकाया बदलाव",
  "suppliers.statement.balance": "बकाया",
  "suppliers.statement.empty": "अभी कोई जुड़ा सप्लायर लेनदेन नहीं है",
  "suppliers.statement.more": "इस समय में 500 से ज्यादा लेनदेन हैं। बाकी देखने के लिए छोटी तारीख सीमा चुनें।",
  "suppliers.statement.repairTitle": "सप्लायर खाता ठीक करें",
  "suppliers.statement.repairDescription": "सिर्फ साफ तौर पर जुड़े पुराने खरीद रिकॉर्ड दोबारा बनेंगे। नाम देखकर अंदाज़ा नहीं लगाया जाएगा और हर सुधार ऑडिट में दर्ज होगा।",
  "suppliers.statement.repairConfirm": "जाँचकर ठीक करें",
