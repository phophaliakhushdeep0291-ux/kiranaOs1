...
export const assistantEn = {
  ...
  "assistant.timeout": "The assistant took too long. Please try again.",
  "assistant.itemsUnresolved": "These items need a more specific name before they can be added:",
  "assistant.pinLocked": "PIN verification is temporarily locked. Wait before trying again.",
