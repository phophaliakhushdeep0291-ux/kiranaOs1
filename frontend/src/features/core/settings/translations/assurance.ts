...
export const assuranceEn = {
  ...
  "assurance.runs.retrySafe": "Checking the same period again will not create duplicate findings.",
  "assurance.runIncomplete": "Check incomplete",
  "assurance.runIncompleteHint": "Some checks are unfinished. Review the run details and retry. If the record limit was reached, check a shorter date range.",
  "assurance.runCoverageDetail": "Records that failed: {failed}. Checks that failed: {rules}. Record groups over the limit: {capped}.",
  "assurance.report.incomplete": "This report includes {count} unfinished or failed runs. It does not confirm that all records were checked.",
  ...
  "assurance.runs.startHint": "Checks recorded entries in the selected dates and shows any incomplete coverage.",
  "assurance.runs.status": "Status",
