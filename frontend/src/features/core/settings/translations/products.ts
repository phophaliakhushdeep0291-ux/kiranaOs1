...
export const productsEn = {
  ...
  "products.form.packRemovedWithStock": "Pack removed, stock written off",
  "products.form.packRemovedWithStockHint": "It held {qty}. Saving will take that off your stock and record it, so the books still add up.",
