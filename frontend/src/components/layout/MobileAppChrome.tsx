...
const MORE_GROUPS: Array<{ label: string; items: NavigationItem[] }> = [
  {
    ...
    items: [
      ...
      { href: "/returns", label: "Returns", helper: "Refund or exchange", Icon: Undo2 },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/categories", label: "Categories", helper: "Organize products", Icon: Tags },
      { href: "/purchase-bills", label: "Purchases", helper: "Receive supplier stock", Icon: ShoppingBag },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/offers", label: "Offers", helper: "Discount rules", Icon: Percent },
      { href: "/loyalty", label: "Loyalty", helper: "Points and members", Icon: HandCoins },
      { href: "/gift-cards", label: "Gift cards", helper: "Issue and redeem", Icon: Gift },
    ],
  },
  {
    label: "Manage",
