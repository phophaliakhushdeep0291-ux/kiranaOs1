...
describe("shop-type subscription pricing", () => {
  it.each([
    ["kirana", 249, 599, 999], ["stationery", 249, 599, 999], ["other", 249, 599, 999],
    ["clothing", 349, 699, 1099], ["footwear", 349, 699, 1099], ["cosmetics", 349, 699, 1099],
    ["auto_parts", 399, 799, 1199], ["electronics", 399, 799, 1199], ["furniture", 399, 799, 1199],
    ["pharmacy", 499, 899, 1299], ["restaurant", 599, 999, 1499],
