...
- Apply both the schema migration and generated client in a release. Production PostgreSQL migration: `000132_restaurant_marketplace_foundation`. Development SQLite: `20260912000000_restaurant_marketplace_foundation`. A plain schema push does not install the partial index.
