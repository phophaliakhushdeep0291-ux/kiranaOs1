# Shop workflow and mobile audit — 8 September 2026
...
| Manufacturing | BOM, production run, raw-material consumption, finished batch, QC and traceability exist. A run consumed 12 raw units and produced 10 finished units; QC/trace records persisted. | Dispatch, wholesale invoicing, returns and export-document workflows need a combined end-to-end pass. |
