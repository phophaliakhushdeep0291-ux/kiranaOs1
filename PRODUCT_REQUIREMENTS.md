...
| SYNC-002 | Retries and multiple devices cannot duplicate financial or stock effects. | Idempotency/concurrency tests; two-device QA. | Backend sync integration passes 39/39, including exact-once financial ledger, stock, same-bill replay and multi-device acknowledgement. A live same-content repeat-sale defect was fixed by requiring durable identity parity before repair-time merging; regression and live cash/split proof preserve both genuine bills. | P0 |
