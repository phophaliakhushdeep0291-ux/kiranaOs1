...
| ADM-002 | Settings expose billing, tax, printer, backup, security and sync safely on mobile. | Permission tests; settings mobile QA. | Partially verified. Subscription/Staff access passes a live server-authoritative transition at 390x844 and settled Staff/Add Staff geometry at 375x667, 430x932 and 768x1024 with zero document overflow or sub-44px active controls; retained artifacts are in `docs/evidence/mobile-staff/`. Billing, tax, printer, backup, security and sync still require equivalent stateful page certification before ADM-002 closes. | P1 |
