...
| Frontend production build/security | `cd frontend && npm run build && npm run security:check` | Local working tree passed 2026-08-08: 3,147 modules; startup 854.2 kB raw / 255.4 kB gzip across 5 files; total JavaScript 3,936.9 kB raw / 1,152.7 kB gzip; largest offline shop payload restaurant 2,417.9 kB raw / 722.2 kB gzip; fixed bundle budgets and production-app checks passed. Translation parity also passes for 1,005 keys across 6 modules. |
