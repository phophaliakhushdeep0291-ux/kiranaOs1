...
| Frontend tests | `cd frontend && npm run test` | Local working tree passed 2026-08-08: 1,313 passed, 1 skipped across 206 passed files and 1 skipped file |
| Frontend production build/security | `cd frontend && npm run build && npm run security:check` | Local working tree passed 2026-08-08: 3,146 modules; startup 853.5 kB raw / 255.2 kB gzip across 5 files; total JavaScript 3,923.4 kB raw / 1,149.4 kB gzip; largest offline shop payload restaurant 2,405.9 kB raw / 718.5 kB gzip; fixed bundle budgets and production-app checks passed |
