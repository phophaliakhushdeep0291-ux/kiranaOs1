...
export async function buildTradePdf(shopId, orderId, kind) {
  ...
  return buildPdf({ ...shared, title: bill.billType === "gst_invoice" ? "TAX INVOICE" : "SALES INVOICE", subtitle: `${bill.billNo} | ${dateOnly(bill.businessDate || bill.createdAt)}`, sections: [
