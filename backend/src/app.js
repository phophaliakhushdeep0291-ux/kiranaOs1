...
app.use("/api/payment-provider/webhooks/razorpay", express.raw({ type: "application/json", limit: "2mb" }));
...
app.use("/api/restaurant/service-ops", restaurantServiceOpsRoutes);
