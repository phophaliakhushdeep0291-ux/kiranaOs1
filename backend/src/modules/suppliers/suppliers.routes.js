...
import { createSupplierSchema, supplierStatementQuerySchema, updateSupplierSchema } from "./suppliers.schema.js";
...
router.get("/:id/statement", validateQuery(supplierStatementQuerySchema), ctrl.statement);
router.post("/:id/statement/rebuild", requireOwnerPin, ctrl.rebuildStatement);
