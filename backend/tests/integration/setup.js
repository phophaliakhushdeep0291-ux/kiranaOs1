...
export async function resetDatabase(db) {
  ...
  await db.$transaction([
    ...
    db.channelSettlementEvent.deleteMany(),
    db.channelSettlementRow.deleteMany(),
    db.channelSettlementImport.deleteMany(),
    ...
    db.bankReconciliationEvent.deleteMany(),
    db.bankReconciliationAllocation.deleteMany(),
    db.bankStatementTransaction.deleteMany(),
    db.bankStatementImport.deleteMany(),
    ...
    db.productAddonGroup.deleteMany(),
    db.menuAddonOption.deleteMany(),
    db.menuAddonGroup.deleteMany(),
    db.dishRecipeComponent.deleteMany(),
