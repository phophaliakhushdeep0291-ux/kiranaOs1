...
function run() {
  ...
  mustContain('src/modules/sync/sync.routes.js', 'router.post("/resolve-conflict", requireDeviceActivated(), ctrl.resolveConflict)', 'sync conflict advisory route must exist');
