ALTER TABLE "PurchaseReceipt" ADD COLUMN "supplierInvoiceAmount" DOUBLE PRECISION;
ALTER TABLE "PurchaseReceipt" ADD COLUMN "supplierInvoiceAmountPaise" BIGINT;
ALTER TABLE "PurchaseReceipt" ADD COLUMN "expectedGoodsAmount" DOUBLE PRECISION NOT NULL DEFAULT 0;
ALTER TABLE "PurchaseReceipt" ADD COLUMN "expectedGoodsAmountPaise" BIGINT;
ALTER TABLE "PurchaseReceipt" ADD COLUMN "priceVarianceAmount" DOUBLE PRECISION NOT NULL DEFAULT 0;
ALTER TABLE "PurchaseReceipt" ADD COLUMN "priceVarianceAmountPaise" BIGINT;
ALTER TABLE "PurchaseReceipt" ADD COLUMN "invoiceVarianceAmount" DOUBLE PRECISION;
...
ALTER TABLE "PurchaseReceipt" ADD COLUMN "varianceApprovedAt" TIMESTAMP(3);
